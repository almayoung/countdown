  ...
  <body>
      ...
      <section id="intro">
          <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <p>My website is ready to launch in...</p>
                  </div>                     
              </div>          
          </div>      
      </section>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <ul class="list-inline">
                    ...
                    <a href="http://www.github.com/" target="blank"><li class="list-inline-item"><i class="fa github fa-github-square fa-3x" aria-hidden="true"></i></li></a>    
                    <a href="https://LinkedIn.com" target="blank"><li class="list-inline-item"><i class="fa linkedin fa-linkedin-square fa-3x" aria-hidden="true"></i></li></a>                                                   
                  </ul>
              </div>          
          </div>
       </div>       
              ...
              <div class="row">
                <div class="col-md-12">
                 <form class="form-inline" role="form" method="post" action="#signup">
                    <input type="email" class="form-control-sm" name="email" placeholder="enter your email">
...
<!--
    <div class="bottomcenter col-md-12 text-center">
    <p>Copyright &copy; Alma Young | 2017 </p>
    </div> 
-->
